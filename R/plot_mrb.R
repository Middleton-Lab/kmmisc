##' This function is intended to be used with scale_continuous from the ggplot2 package to reformat axis labels as base-10 exponents. See \url{http://goo.gl/fNMKjB} for more information.
##'
...
##' 
##' @param logfile The MrBayes log file to be loaded. If \code{logfile = NULL}, then the user is prompted to choose a file.
##' @param burnin The burnin period, either specified in absolute number of generations or as a fraction of the total number of generations (\code{burnin} < 1). The default is 0.25.
##' @param lwd Line width for the plot. Defaults to 1.5.
##' @param cutoff The minimum value for acceptable convergence. Only applicable for mcmc files. Defaults to 0.05.
##' @param ideal The ideal value for acceptable convergence. Only applicable for mcmc files. Defaults to 0.01.
